    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-base text-gray-400">Human ({((data.botVsHuman.human.requests / data.totalRequests) * 100).toFixed(1)}%)</div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-base text-gray-400">Bots ({((data.botVsHuman.bot.requests / data.totalRequests) * 100).toFixed(1)}%)</div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 md:p-4">
        <h3 className="text-base md:text-lg font-semibold mb-3">All Bots</h3>
      ...
      {google && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 md:p-4 space-y-4">
          <h3 className="text-base md:text-lg font-semibold">🔍 Googlebot Detail ({google.requests.toLocaleString()} requests)</h3>
          ...
          <div>
            <h4 className="text-xs md:text-sm text-gray-400 mb-2">Top Crawled Pages</h4>
